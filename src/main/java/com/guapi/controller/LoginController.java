...
public class LoginController implements CommunityConstant {
    ...
    //http://localhost:80/guapi/activation/id/激活码
...
//        session.setAttribute("kaptcha", text);
    ...
    public String login(String username, String password, String code, boolean remember, Model model, /*HttpSession session, */HttpServletResponse response,@CookieValue("kaptchaowner") String kaptchaOwner) {
...
//            System.out.println("重定向回到主页");
//            logger.info("登录成功，重定向回到主页");
            return "redirect:/index";
        } else {
            model.addAttribute("usernameMsg", map.get("usernameMsg"));
            model.addAttribute("passwordMsg", map.get("passwordMsg"));
